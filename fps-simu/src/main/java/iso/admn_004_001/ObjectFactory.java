...
public class ObjectFactory {
    ...
    private final static QName _SignOffResponse_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:admn.004.001.01", "SignOffResponse");
    ...
    /**
     * Create an instance of {@link AdmnSignOffResp }
     * 
     */
    public AdmnSignOffResp createAdmnSignOffResp() {
        return new AdmnSignOffResp();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:admn.004.001.01", name = "SignOffResponse")
    public JAXBElement<Document> createSignOffResponse(Document value) {
        return new JAXBElement<Document>(_SignOffResponse_QNAME, Document.class, null, value);
    }
