 ...
 * generated in the iso.std.iso._20022.tech.xsd.admn_006_001 package. 
...
public class ObjectFactory {
    ...
    private final static QName _EchoResponse_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:admn.006.001.01", "EchoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: iso.std.iso._20022.tech.xsd.admn_006_001
     * 
     */
    ...
    /**
     * Create an instance of {@link AdmnEchoResp }
     * 
     */
    public AdmnEchoResp createAdmnEchoResp() {
        return new AdmnEchoResp();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:admn.006.001.01", name = "EchoResponse")
    public JAXBElement<Document> createEchoResponse(Document value) {
        return new JAXBElement<Document>(_EchoResponse_QNAME, Document.class, null, value);
    }
