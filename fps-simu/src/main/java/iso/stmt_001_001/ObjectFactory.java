 ...
 * generated in the iso.std.iso._20022.tech.xsd.stmt_001_001 package. 
...
public class ObjectFactory {
    ...
    private final static QName _BankStatementRequest_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:stmt.001.001.01", "BankStatementRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: iso.std.iso._20022.tech.xsd.stmt_001_001
     * 
     */
    ...
    /**
     * Create an instance of {@link BankStmtReq }
     * 
     */
    public BankStmtReq createBankStmtReq() {
        return new BankStmtReq();
    }
    ...
    /**
     * Create an instance of {@link StmtReq }
     * 
     */
    public StmtReq createStmtReq() {
        return new StmtReq();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:stmt.001.001.01", name = "BankStatementRequest")
    public JAXBElement<Document> createBankStatementRequest(Document value) {
        return new JAXBElement<Document>(_BankStatementRequest_QNAME, Document.class, null, value);
    }
