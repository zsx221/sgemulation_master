 ...
 * generated in the iso.std.iso._20022.tech.xsd.stmt_002_001 package. 
...
public class ObjectFactory {
    ...
    private final static QName _BankStatementResponse_QNAME = new QName("urn:iso:std:iso:20022:tech:xsd:stmt.002.001.01", "BankStatementResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: iso.std.iso._20022.tech.xsd.stmt_002_001
     * 
     */
    ...
    /**
     * Create an instance of {@link BankStmtResp }
     * 
     */
    public BankStmtResp createBankStmtResp() {
        return new BankStmtResp();
    }
    ...
    /**
     * Create an instance of {@link StmtResp }
     * 
     */
    public StmtResp createStmtResp() {
        return new StmtResp();
    }
     ...
     */
    @XmlElementDecl(namespace = "urn:iso:std:iso:20022:tech:xsd:stmt.002.001.01", name = "BankStatementResponse")
    public JAXBElement<Document> createBankStatementResponse(Document value) {
        return new JAXBElement<Document>(_BankStatementResponse_QNAME, Document.class, null, value);
    }
